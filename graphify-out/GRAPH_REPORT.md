...
## Corpus Check
- 71 files · ~8,000 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 71 nodes · 100 edges · 9 communities
...
Cohesion: 0.22
Nodes (8): escapeHtml(), fallbackCopyText(), onCopySuccess(), refreshSafetyTimer(), resetBusyState(), runDirectFallback(), setWorking(), toggleTheme()

### Community 4 - "Community 4"
Cohesion: 0.22
Nodes (8): closeResults(), copyDetailsToClipboard(), filterDetails(), formatEta(), processNextBatch(), run(), showResult(), updateProgress()
...
- **Why does `onOpen()` connect `Community 2` to `Community 0`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `openManagerPanel()` connect `Community 2` to `Community 0`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `createMonthlySheetsSafe()` connect `Community 2` to `Community 0`?**
